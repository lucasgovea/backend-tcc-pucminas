...
@AllArgsConstructor
public class ProfissionalSpecification implements Specification<Profissional> {

	private static final long serialVersionUID = 5336306615607552662L;
	
	private ProfissionalFilterDTO filter;

    @Override
    public Predicate toPredicate (Root<Profissional> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
